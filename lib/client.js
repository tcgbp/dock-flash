...
window.__ModuleLoader__.load({
  id: 'dock-flash',
  factory: (require) => {
    console.log('[dock-flash] client v1.0.15')
...
//#region PanelComponent ───────────────────────────────────────────────────────
    ...
    function QuickControlPanel(props) {
       ...
       *  touched it, otherwise OPEN. Folded-by-default would reproduce exactly
       *  what the fold exists to replace — a control the user cannot see — so a
       *  cluster shows everything until the user tucks it away. */
