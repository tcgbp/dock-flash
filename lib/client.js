...
//#region StandaloneMode ───────────────────────────────────────────────────────
    ...
    function mountStandaloneSlotTrigger(ctx, registry) {
      ...
      //
      // The layer presets are ordered by the MEASURED host UI, not by taste:
      // DSH's own bundles top out at 1100 (`dsh-client-ui-chat`,
      // `dsh-client-ui-model-selection`), with settings/attachment popovers at
      // 1000 and most of the chat chrome at 100. The old hardcoded 99997-99999
      // sat ~90x above that and covered every popover in the host.
      var LAYER_PRESETS = [
        { value: 1050, label: '1050' },   // below DSH's chat / model-selection layer
        { value: 1150, label: '1150' },   // DEFAULT: clear of DSH's highest, same order
        { value: 2000, label: '2000' },   // clear of DSH with headroom to spare
      ]
      var OPACITY_PRESETS = [
